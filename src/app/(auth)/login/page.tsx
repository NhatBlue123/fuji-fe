  ...
  return (
    <div className="h-screen w-full overflow-hidden flex items-center justify-center relative bg-background-dark">
      ...
      <div className="absolute inset-0 z-0 overflow-hidden">
        ...
        <div className="absolute top-[30%] -right-[20%] w-[140%] h-[500px] bg-gradient-to-r from-transparent via-pink-400/25 to-transparent blur-[90px] animate-aurora-flow-2" style={{ animationDelay: "-5s" }}></div>
