              ...
              <div className="mt-12 pt-8 border-t border-white/5 flex flex-wrap items-center gap-8">
                ...
                <div className="ml-auto flex gap-3">
                  <Button
                    variant="outline"
                    size="icon"
                    className="h-12 w-12 rounded-2xl bg-white/5 border-white/10 text-white hover:bg-pink-500/10 hover:border-pink-500/30 hover:text-pink-400 transition-colors shadow-inner"
                  >
                    <Download size={20} />
                  </Button>
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent
                      align="end"
                      className="bg-[#0f1218] border border-pink-500/20 text-slate-200 rounded-xl backdrop-blur-xl min-w-[180px]"
                    >
                      <DropdownMenuItem className="hover:bg-pink-500/10 hover:text-pink-300 focus:bg-pink-500/10 focus:text-pink-300 cursor-pointer text-xs font-semibold py-2.5">
                        Lấy mã QR thanh toán
                      </DropdownMenuItem>
                      <DropdownMenuItem className="hover:bg-pink-500/10 hover:text-pink-300 focus:bg-pink-500/10 focus:text-pink-300 cursor-pointer text-xs font-semibold py-2.5">
                        Cài đặt thông báo
                      </DropdownMenuItem>
                      <DropdownMenuItem className="hover:bg-rose-500/10 hover:text-rose-400 focus:bg-rose-500/10 focus:text-rose-400 text-rose-400 cursor-pointer text-xs font-semibold py-2.5">
                        Báo cáo sự cố
                      </DropdownMenuItem>
                    </DropdownMenuContent>
                  </DropdownMenu>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <CardDescription className="text-muted-foreground dark:text-slate-400">
                  Chi tiết các biến động số dư của bạn
                </CardDescription>
              </div>
            </div>
                  ...
                  >
                    <TableCell className="px-8 py-6">
                      <div className="flex items-center gap-4">
                        ...
                        <div
                          className={`w-10 h-10 rounded-xl flex items-center justify-center border transition-transform group-hover:scale-110 shadow-inner md:flex-shrink-0 ${
                    ...
                    <TableCell className="px-8 py-6 text-right">
                      ...
                      <Badge
                        variant="secondary"
                        className="bg-emerald-500/10 text-emerald-600 border border-emerald-500/20 text-[9px] font-black uppercase ring-0 px-3 py-1 shadow-inner"
                      >
                        Thành công
                      </Badge>
                    </TableCell>
                      ...
                      <div className="flex flex-col items-center gap-4">
                        ...
                        <div className="space-y-1">
                          ...
                          <p className="text-[11px] text-muted-foreground dark:text-slate-500 mb-4 max-w-xs mx-auto">
                            Mọi hoạt động của bạn sẽ được ghi lại tại đây để
                            tiện theo dõi
                          </p>
                          <Button
                            variant="outline"
                ...
                <div className="flex gap-1">
                  {[...Array(Math.min(totalPages, 5))].map((_, i) => (
                    <Button
                      ...
                      onClick={() => setPage(i)}
                      className={`h-11 w-11 rounded-xl font-bold text-xs ${
                        page === i
