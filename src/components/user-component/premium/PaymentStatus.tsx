          ...
          <div className="absolute inset-0 z-[60] flex items-center justify-center bg-[#0a0c10]/80 backdrop-blur-md animate-in fade-in zoom-in duration-200">
            <div className="bg-[#1a1d29] border border-white/10 p-10 rounded-[2.5rem] max-w-sm w-full mx-4 shadow-2xl text-center space-y-6">
              ...
              <div className="space-y-2">
                <h4 className="text-2xl font-black text-white uppercase tracking-tight">Xác nhận hủy?</h4>
          ...
          <div className="p-10 flex flex-col justify-between">
            <div className="space-y-6">
              <div>
                ...
                <p className="text-slate-500 text-sm mt-1">Thực hiện chuyển khoản theo thông tin bên dưới</p>
              </div>
              ...
              <div className="space-y-3">
                ...
                <div className="p-4 bg-indigo-500/10 rounded-2xl border border-indigo-500/20 flex items-center justify-between">
                  <div>
                    <p className="text-[10px] font-black uppercase text-pink-400 tracking-widest">Số tiền cần nạp</p>
              ...
              <div className="p-5 bg-yellow-500/5 border border-yellow-500/20 rounded-2xl relative overflow-hidden group">
                <div className="relative z-10">
                  <p className="text-[10px] font-black uppercase text-pink-500 tracking-[0.2em] mb-2">Nội dung bắt buộc</p>
                  <div className="flex items-center justify-between font-mono">
                    <span className="text-2xl font-black text-white tracking-widest">{orderId}</span>
                    <button onClick={() => copyToClipboard(orderId, "nội dung")} className="p-2 hover:bg-yellow-500/20 rounded-lg text-pink-500 transition-colors">
                      <Copy size={18} />
                    </button>
                  </div>
                </div>
            ...
            <div className="mt-8 pt-8 border-t border-white/5 space-y-4">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2 text-pink-400">
                  ...
                  <span className="text-xs font-bold uppercase tracking-widest">Đang chờ...</span>
                </div>
