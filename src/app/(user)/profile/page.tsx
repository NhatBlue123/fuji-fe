...
export default function ProfilePage() {
  ...
  return (
    <div className="min-h-screen bg-transparent transition-colors duration-500 relative selection:bg-pink-500/30">
      ...
      <div className="space-y-8 animate-in fade-in duration-500 max-w-7xl mx-auto py-8 px-4 relative z-10">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 border-b border-muted/50 pb-8">
        <div className="space-y-1">
          ...
          <p className="text-muted-foreground">Quản lý diện mạo và thông tin liên hệ của bạn.</p>
        </div>
      </div>
            ...
            <div className="flex-1 space-y-4">
              <div className="space-y-1">
                <div className="flex flex-wrap items-center justify-center md:justify-start gap-3">
                  ...
                  <Badge className="bg-gradient-to-r from-pink-500 to-purple-500 border-none text-white font-black uppercase tracking-widest text-[10px] px-3 shadow-[0_0_15px_rgba(236,72,153,0.5)]">
                    Premium
                  </Badge>
                </div>
