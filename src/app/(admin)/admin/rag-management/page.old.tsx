        ...
        <div className="rounded-2xl border bg-card p-5 space-y-4">
          ...
          >
            ...
            <TabsContent value="guide" className="mt-4 space-y-4">
              ...
              {/* Legacy Google Sheet Section - Deprecated */}
              <details className="rounded-xl border bg-muted/20 p-4">
                <summary className="cursor-pointer font-semibold text-sm text-muted-foreground">
                  [DEPRECATED] Google Sheet-based Guide (Legacy)
                </summary>
                <div className="mt-4 space-y-4">
                  <div className="rounded-lg border border-yellow-300 bg-yellow-50 px-4 py-3 text-sm text-yellow-800">
                    ⚠️ Phần này đã lỗi thời. Hệ thống mới sử dụng document-based architecture phía trên.
                    Phần này chỉ giữ lại để tham khảo và backward compatibility.
                  </div>
