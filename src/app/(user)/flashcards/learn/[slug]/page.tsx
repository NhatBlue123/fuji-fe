...
export default function FlashcardStudyPage({
  ...
  }, [currentIndex, totalCards, router, detailHref]);
          ...
          <Dialog>
            ...
            <DialogContent className="sm:max-w-md">
              ...
              <div className="grid gap-4 py-4">
                <Link
                  href={buildFlashcardExerciseHref(flashcard, "multiple-choice")}
                ...
                <Link
                  href={buildFlashcardExerciseHref(flashcard, "fill-blank")}
