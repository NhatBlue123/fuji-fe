...
export const API_CONFIG = {
  BASE_URL: process.env.NEXT_PUBLIC_API_URL || "http://localhost:8181/api/v1",
  HEALTH_CHECK: process.env.NEXT_PUBLIC_BACKEND_HEALTH_CHECK || "http://localhost:8181/testServer",
  TIMEOUT: 10000,
  RETRY_ATTEMPTS: 3,
  RETRY_DELAY: 1000
};
