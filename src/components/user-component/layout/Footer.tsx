            ...
            <div className="px-6 md:px-12 lg:px-20 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8 pb-12">
                <div className="lg:col-span-4 flex flex-col gap-6">
                    <div className="flex items-center gap-3">
                        ...
                        <h2 className="text-2xl font-black tracking-tight text-foreground">FUJI</h2>
                    </div>
                    ...
                    <div className="flex gap-4">
                        <a className="size-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-muted-foreground hover:bg-blue-600 hover:text-white hover:border-blue-600 transition-all group" href="#">
                        ...
                        <a className="size-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-muted-foreground hover:bg-red-600 hover:text-white hover:border-red-600 transition-all" href="#">
                        ...
                        <a className="size-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-muted-foreground hover:bg-white hover:text-black hover:border-white transition-all" href="#">
                ...
                <div className="lg:col-span-2 flex flex-col gap-5">
                    <h4 className="text-foreground font-bold uppercase tracking-wider text-sm">Về FUJI</h4>
                ...
                <div className="lg:col-span-2 flex flex-col gap-5">
                    <h4 className="text-foreground font-bold uppercase tracking-wider text-sm">Học tập</h4>
                    <ul className="flex flex-col gap-3 text-muted-foreground font-medium">
                ...
                <div className="lg:col-span-4 flex flex-col gap-5">
                    <h4 className="text-foreground font-bold uppercase tracking-wider text-sm">Đăng ký nhận tin</h4>
                    <p className="text-muted-foreground text-sm leading-relaxed">Nhận mẹo học tiếng Nhật và ưu đãi khóa học mới nhất từ FUJI.</p>
            ...
            <div className="px-6 md:px-12 lg:px-20 border-t border-white/5 py-8">
                <div className="flex flex-col md:flex-row justify-between items-center gap-6">
                    <div className="flex gap-8 text-xs font-bold text-muted-foreground uppercase tracking-widest">
                        <a className="hover:text-foreground transition-colors" href="#">Điều khoản</a>
                        <a className="hover:text-foreground transition-colors" href="#">Bảo mật</a>
                        <a className="hover:text-foreground transition-colors" href="#">Trung tâm trợ giúp</a>
                    </div>
                    <p className="text-muted-foreground text-sm font-medium">© 2024 FUJI. All rights reserved.</p>
                </div>
            </div>
        </footer>
    );
