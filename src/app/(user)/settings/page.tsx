...
} from "@/store/services/user/userPreferenceApi";
...
function SettingsPageContent() {
  ...
  const handleSave = async () => {
    try {
      ...
      toast.success(
        t("settings.notifications.saveSuccess") || "Đã lưu cài đặt thành công!",
      );
    } catch (err) {
      toast.error(
          ...
          <nav className="lg:col-span-3 space-y-6 lg:sticky lg:top-8">
            ...
            <div className="bg-white/60 dark:bg-[#0B1120]/60 backdrop-blur-xl border border-muted dark:border-white/10 shadow-xl shadow-black/5 dark:shadow-2xl rounded-[2rem] p-4 space-y-2">
              ...
              >
                ...
                {t("profile.badge")}
                <ChevronRight
                  className="size-3 ml-auto opacity-50"
                  strokeWidth={3}
                />
              </Link>
              <Link
                      ...
                      {[
                        {
                          ...
                          icon: Sun,
                          color:
                            "hover:text-amber-500 hover:border-amber-500/40 hover:bg-amber-500/10 hover:shadow-amber-500/10",
                        },
                        {
                          value: "dark",
                          ...
                          icon: Moon,
                          color:
                            "hover:text-indigo-400 hover:border-indigo-400/40 hover:bg-indigo-400/10 hover:shadow-indigo-500/10",
                        },
                        {
                          value: "system",
                          ...
                          icon: Monitor,
                          color:
                            "hover:text-emerald-500 hover:border-emerald-500/40 hover:bg-emerald-500/10 hover:shadow-emerald-500/10",
                        },
                        ...
                        return (
                          ...
                          >
                            ...
                            <div
                              className={cn(
                                "p-4 rounded-2xl border bg-background shadow-sm transition-colors",
                                isSelected
                                  ? "border-pink-500/30 text-pink-500"
                                  : "border-muted dark:border-white/10 dark:bg-white/5",
                              )}
                            >
                      ...
                      {[
                        {
                          key: "courseUpdates",
                          label: t(
                            "settings.notifications.items.courseUpdates.label",
                          ),
                          desc: t(
                            "settings.notifications.items.courseUpdates.desc",
                          ),
                          color: "text-blue-500",
                        },
                        {
                          key: "newMessages",
                          label: t(
                            "settings.notifications.items.newMessages.label",
                          ),
                          desc: t(
                            "settings.notifications.items.newMessages.desc",
                          ),
                        ...
                        },
                        {
                          key: "examReminders",
                          label: t(
                            "settings.notifications.items.examReminders.label",
                          ),
                          desc: t(
                            "settings.notifications.items.examReminders.desc",
                          ),
                        ...
                        },
                        {
                          ...
                          label: t(
                            "settings.notifications.items.bookingReminders.label",
                          ),
                          desc: t(
                            "settings.notifications.items.bookingReminders.desc",
                          ),
                        ...
                        },
                        {
                          key: "systemAlerts",
                          label: t(
                            "settings.notifications.items.systemAlerts.label",
                          ),
                          desc: t(
                            "settings.notifications.items.systemAlerts.desc",
                          ),
                          color: "text-rose-500",
                        },
                        {
                          key: "emailDigest",
                          label: t(
                            "settings.notifications.items.emailDigest.label",
                          ),
                          desc: t(
                            "settings.notifications.items.emailDigest.desc",
                          ),
                        ...
                        <div key={key}>
                          <div className="flex items-center justify-between py-5 group hover:bg-muted/30 dark:hover:bg-white/5 px-4 rounded-2xl transition-colors">
                            <div className="flex items-center gap-4">
                              ...
                              />
                              <div>
                                <p className="text-xs font-black uppercase tracking-widest text-foreground dark:text-white">
                                  {label}
                                </p>
                                <p className="text-[10px] font-bold text-muted-foreground dark:text-slate-400 mt-1">
                                  {desc}
                                </p>
                              </div>
                            </div>
                          ...
                          {i < arr.length - 1 && (
                            <Separator className="opacity-50 dark:opacity-20 mx-4 w-auto" />
                          )}
                        </div>
                      ))}
                    </div>
                    ...
                    {mounted ? (
                      ...
                      >
                        ...
                        <SelectContent className="bg-background dark:bg-[#0f1218] border border-muted dark:border-white/10 rounded-2xl shadow-2xl p-2">
                          <SelectItem
                            value="vi"
                            className="text-xs font-black uppercase tracking-widest py-4 px-4 hover:bg-cyan-500/10 focus:bg-cyan-500/10 focus:text-cyan-500 rounded-xl cursor-pointer transition-colors"
                          >
                            🇻🇳 Tiếng Việt
                          </SelectItem>
                          <SelectItem
                ...
                <CardContent className="p-8 space-y-5">
                    ...
                    <Link href="/profile/change-password">
                      <div className="flex items-center gap-4">
                        ...
                        <div className="text-left space-y-1">
                          <p className="text-xs font-black uppercase tracking-widest text-foreground dark:text-white group-hover:text-amber-500 transition-colors">
                            {t("settings.security.resetPassword")}
                          </p>
                          <p className="text-[10px] font-bold text-muted-foreground dark:text-slate-500 uppercase">
                  ...
                  >
                    <div className="flex items-center gap-4">
                      ...
                      <div className="text-left space-y-1">
                        <p className="text-xs font-black uppercase tracking-widest text-foreground dark:text-slate-300">
                    ...
                    <Badge
                      variant="outline"
                      className="text-[9px] font-black uppercase tracking-widest bg-muted dark:bg-white/5 border-muted dark:border-white/10 px-3 py-1"
                    >
                  ...
                  <CardContent className="p-8 space-y-8">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="p-5 rounded-[1.5rem] bg-muted/20 border border-muted dark:border-white/5 space-y-4 hover:border-secondary/30 transition-all group">
                        ...
                        <Button
                          asChild
                          className="w-full rounded-xl font-black uppercase tracking-widest text-[10px] bg-secondary/10 hover:bg-secondary/20 text-secondary border-none h-10"
                        >
                          <Link href="/help">
                            {t("settings.support.accessNow")}
                          </Link>
                        </Button>
                      </div>
                    ...
                    <div className="space-y-4">
                      <p className="text-[10px] font-black uppercase tracking-widest text-muted-foreground ml-1">
                        {t("settings.support.contactChannels")}
                      </p>
                      <div className="flex flex-wrap gap-4">
                        {[
                          {
                            label: t("settings.support.channels.hotline"),
                            value: "1900 8888",
                            icon: HeartHandshake,
                            color: "text-amber-500",
                          },
                          {
                            label: t("settings.support.channels.email"),
                            value: "support@fuji.edu.vn",
                            icon: MessageCircle,
                            color: "text-pink-500",
                          },
                          {
                            label: t("settings.support.channels.messenger"),
                            value: "fb.com/fuji.jlpt",
                            icon: Sparkles,
                            color: "text-blue-500",
                          },
                        ].map((item) => {
                          ...
                          return (
                            <div
                              key={item.label}
                              className="flex items-center gap-3 px-5 py-3 rounded-2xl bg-muted/30 border border-muted/50"
                            >
