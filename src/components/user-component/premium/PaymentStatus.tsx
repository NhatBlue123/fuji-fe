          ...
          <div className="p-10 flex flex-col justify-between">
            <div className="space-y-6">
              ...
              <div className="p-5 bg-yellow-500/5 border border-yellow-500/20 rounded-2xl relative overflow-hidden group">
                <div className="relative z-10">
                  <p className="text-[10px] font-black uppercase text-yellow-500 tracking-[0.2em] mb-2">
                    Nội dung bắt buộc
                  </p>
            ...
            <div className="mt-8 pt-8 border-t border-white/5 space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                {/* Nút Hủy ban đầu */}
                <Button
                  onClick={() => setIsConfirming(true)} // Thay đổi ở đây
                  variant="ghost"
                ...
                {/* --- OVERLAY XÁC NHẬN HỦY --- */}
                {isConfirming && (
                  <div className="absolute inset-0 z-50 flex items-center justify-center bg-[#0a0c10]/80 backdrop-blur-md animate-in fade-in zoom-in duration-200">
                    <div className="bg-[#1a1d29] border border-white/10 p-8 rounded-[2rem] max-w-sm w-full mx-4 shadow-2xl text-center space-y-6">
                      ...
                      <div className="space-y-2">
                        ...
                        <p className="text-slate-400 text-sm font-medium">
                          Giao dịch sẽ bị dừng lại và mã QR này sẽ không còn
                          hiệu lực. Bạn có chắc chắn không?
                        </p>
                      </div>

                      <div className="flex flex-col gap-3">
                        <Button
                          onClick={onClose} // Thực hiện hủy thực sự
                          className="h-14 rounded-2xl bg-pink-400 hover:bg-blue-400 text-white font-black uppercase text-xs tracking-widest shadow-lg shadow-red-500/20"
                        >
                          Đồng ý hủy
                        </Button>
                        <button
                          onClick={() => setIsConfirming(false)} // Quay lại
